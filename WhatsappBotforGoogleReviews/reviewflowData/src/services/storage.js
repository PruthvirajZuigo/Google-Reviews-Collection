...
function findByPhone(phone) {
  const records = readAll();
  return records.filter((r) => r.phone === phone).sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));
}


module.exports = { readAll, writeAll, appendRecord, seedIfEmpty, markClicked, findByPhone };
